...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { rel: "canonical", href: "https://sultan-vibes-hub.onrender.com/" },
      {
        property: "og:title",
      ...
      { property: "og:url", content: "https://sultan-vibes-hub.onrender.com/" },
      { property: "og:image", content: "https://sultan-vibes-hub.onrender.com/favicon.png" },
      ...
      { name: "twitter:image", content: "https://sultan-vibes-hub.onrender.com/favicon.png" },
