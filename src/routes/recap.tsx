      ...
      <div className="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filtered.map((e) => (
          <Link
            key={e.id}
            to="/recap"
            className="group glass rounded-3xl overflow-hidden kente-border"
          >
            <div className="relative aspect-[4/3] overflow-hidden">
              ...
              <div className="absolute bottom-3 left-3 right-3 flex items-center gap-3 text-[10px] uppercase tracking-wider font-mono text-foreground/80">
                <span className="inline-flex items-center gap-1">
                  <Camera size={12} /> {e.photos}
                </span>
                <span className="inline-flex items-center gap-1">
                  <Video size={12} /> {e.videos}
                </span>
              </div>
            </div>
            <div className="p-5">
              ...
              <div className="mt-3 flex items-center justify-between text-xs">
                <span className="text-foreground/55">
                  Bundle from <span className="text-gold">KES {e.bundle}</span>
                </span>
